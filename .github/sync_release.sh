...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Casio_PV-2000_MiSTer.git"
CORE_NAME=(Casio_PV-2000)
...
UPSTREAM_CORE_NAME=(Casio_PV-2000)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Casio_PV-2000.qpf)
COMPILATION_OUTPUT=(output_files/Casio_PV-2000.rbf)
